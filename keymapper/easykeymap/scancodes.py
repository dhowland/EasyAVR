...
scancodes = {
    ...
    "HID_KEYBOARD_SC_INTERNATIONAL1": ("_\n\\", 0x87, "\\_"),
    "HID_KEYBOARD_SC_INTERNATIONAL2": ("Kana", 0x88, "Kana"),
    "HID_KEYBOARD_SC_INTERNATIONAL3": ("Yen", 0x89, "Yen"),
    "HID_KEYBOARD_SC_INTERNATIONAL4": ("Henkan", 0x8A, "Henkan"),
    "HID_KEYBOARD_SC_INTERNATIONAL5": ("Muhen", 0x8B, "Muhen"),
