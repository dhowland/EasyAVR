...
class Picker(object):
    ...
    def createwindow(self):
        ...
        Spacer(rowframe, 4, 4)
        Selector(rowframe, self.main, 4, "HID_KEYBOARD_SC_INTERNATIONAL1")
        Selector(rowframe, self.main, 4, "HID_KEYBOARD_SC_INTERNATIONAL2")
        Selector(rowframe, self.main, 4, "HID_KEYBOARD_SC_INTERNATIONAL3")
        Selector(rowframe, self.main, 4, "HID_KEYBOARD_SC_INTERNATIONAL4")
        Selector(rowframe, self.main, 4, "HID_KEYBOARD_SC_INTERNATIONAL5")
        Spacer(rowframe, 2, 4)
