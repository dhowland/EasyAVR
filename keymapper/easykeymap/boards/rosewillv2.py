...
"""Keyboard definition for Tiger Lily controller"""

import easykeymap.templates.ATmega32U2_16MHz_COSTAR as firmware
from easykeymap.ioports import *

description = "Filco/Rosewill 104 (Tiger Lily)"
unique_id = "TIGERLILY_001"
cfg_name = "costar104"
...
matrix_hardware = [
#     Port mask     Dir mask
    ( 0b01111110 , 0b00000000 ),    # REF_PORTB
    ( 0b10000100 , 0b00000000 ),    # REF_PORTC
    ( 0b01110111 , 0b01110111 )     # REF_PORTD
]
...
#     REF_PORTB    REF_PORTC    REF_PORTD
    ...
    ( 0b00000000 , 0b00000000 , 0b01000111 ),
    ( 0b00000000 , 0b00000000 , 0b01000011 ),
    ( 0b00000000 , 0b00000000 , 0b00110111 ),
    ...
    ( 0b00000000 , 0b00000000 , 0b01100101 ),
    ( 0b00000000 , 0b00000000 , 0b01100001 ),
    ( 0b00000000 , 0b00000000 , 0b01110110 ),
    ( 0b00000000 , 0b00000000 , 0b01110010 ),
