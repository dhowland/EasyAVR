...
matrix_hardware = [
#     Port mask     Dir mask
    ( 0b01111110 , 0b01111110 ),    # REF_PORTB
    ( 0b10000100 , 0b00000000 ),    # REF_PORTC
    ( 0b01110111 , 0b00000000 )     # REF_PORTD
]
...
#     REF_PORTB    REF_PORTC    REF_PORTD
    ...
    ( 0b01011000 , 0b00000000 , 0b00000000 ),
    ( 0b00111010 , 0b00000000 , 0b00000000 ),
    ( 0b00011010 , 0b00000000 , 0b00000000 ),
