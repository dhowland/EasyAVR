...
"""Keyboard definition for the Atomic custom keyboard."""
...
keyboard_definition = [
    [((4, 4), (0, 0), 'HID_KEYBOARD_SC_GRAVE_ACCENT_AND_TILDE'),
     ...
     ((4, 4), (0, 14), 'HID_KEYBOARD_SC_BACKSPACE')],
    ...
    [((4, 4), (2, 0), 'HID_KEYBOARD_SC_ESCAPE'),
     ...
     ((4, 4), (2, 12), 'HID_KEYBOARD_SC_ENTER'),
     ((4, 4), (2, 13), 'HID_KEYBOARD_SC_ENTER'),
    ...
    [((4, 4), (4, 0), 'HID_KEYBOARD_SC_CAPS_LOCK'),
     ...
     ((4, 4), (4, 8), 'HID_KEYBOARD_SC_RIGHT_ALT'),
     ((4, 4), (4, 9), 'HID_KEYBOARD_SC_RIGHT_GUI'),
     ((4, 4), (4, 10), 'HID_KEYBOARD_SC_RIGHT_CONTROL'),
     ((4, 4), (4, 11), 'HID_KEYBOARD_SC_HOME'),
